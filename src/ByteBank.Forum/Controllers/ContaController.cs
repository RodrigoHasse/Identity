...
namespace ByteBank.Forum.Controllers
{
    public class ContaController : Controller
    {
            ...
            if (ModelState.IsValid)
            {
                ...
                switch (signInResultado)
                {
                    ...
                    case SignInStatus.RequiresVerification:
                        return Redirect("VerificacaoDoisFatores");
        ...
        {
            var resultado = await SignInManager.TwoFactorSignInAsync("SMS", modelo.token, isPersistent: modelo.ContinuarLogado, rememberBrowser: modelo.LembrarDesteComputador);
