    ...
    public class Startup
    {
        public void Configuration(IAppBuilder builder)
        {
            ...
            builder.UseCookieAuthentication(new CookieAuthenticationOptions
            {
                 ...
                 {
                     OnValidateIdentity = SecurityStampValidator.OnValidateIdentity<UserManager<UsuarioAplicacao>, UsuarioAplicacao>
                     (
            ...
            builder.UseTwoFactorSignInCookie(DefaultAuthenticationTypes.TwoFactorCookie,
